...
![](TuesdayAnalysis_files/figure-gfm/target-1.png)<!-- -->
...
![](TuesdayAnalysis_files/figure-gfm/target-2.png)<!-- -->
...
![](TuesdayAnalysis_files/figure-gfm/boxplot-1.png)<!-- -->
...
![](TuesdayAnalysis_files/figure-gfm/barchart-1.png)<!-- -->

The plot above shows of the median shares per channel for Tuesday.
